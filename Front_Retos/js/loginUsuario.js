        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (items) {
                    ...
                    if (opc) {
                        window.location.href = "contactoAdmi.html";
                    } else {
                        email.focus();
                        return 0;
                    }
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (items.id != null) {
                ...
                let opc = confirm('¡No existe un usuario! Si deseas crear un usuario comunicate con un Administrador.');
                if (opc) {
                    window.location.href = "contactoAdmi.html";
                } else {
                    mostrarPassword();
